...
with dataset:
    ...
    cores_classes = [COR4, COR3, COR2]
    cores_notas_semestres = [COR3, COR4, COR2]
    ...
    rf_model = train_model(rf, X, y, 'rf4_1', MODELS_DIR)
    ...
    rf_model_2 = train_model(rf2, X, y, 'rf4_2', MODELS_DIR)
